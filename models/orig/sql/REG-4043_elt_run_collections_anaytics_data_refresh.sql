...
from 
pro_sandbox.ca_ptp_all ptp_all1 
inner join pro_sandbox.ca_ptp_payments_all ptp_pay_all1
on ptp_all1.ptpid = ptp_pay_all1.ptpid;


/*
v_section := 20; 
call elt.logging(v_jobname, v_section);
@creation-date 2022127 @author iuri.dearaujo@wexinc.com 
*/
