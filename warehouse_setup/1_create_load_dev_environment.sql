...
from pro_sandbox.ca_salesforce_driver1           a 
 ...
 and b.business_date between a.case_create_dt and a.case_closed_dt
     left outer join pro_sandbox.ca_pastdue_otr1 c
...
FROM 
pro_sandbox.ca_sf_task_penetration_calls_stage1 a;
...
,Nbr_of_Calls
from 
pro_sandbox.ca_sf_task_penetration_calls_stage1;
...
from pro_sandbox.ca_salesforce1                 a
     left outer join
     pro_sandbox.ca_get_amt_due1                   b
  on a.case_casenumber = b.case_casenumber
 and a.case_create_dt  = b.case_create_dt
      left outer join 
      pro_sandbox.ca_Promise_Payments1                 e
  on a.ptpid = e.ptpid
     left outer join
     pro_sandbox.ca_sf_payments1                      f
 ...
 and a.case_create_dt  = f.case_create_dt 
  ...
  on a.match_key = h.wex_acct_nbr  
     left outer join 
     pro_sandbox.ca_efs_customer_current1 i
